            ...
            for (;;)
            {
                if (req->request.addition.has_value())
                {
                    try
                    {
                        ...
                        ReplyType reply{};
                        reply.addition = calculator_base::detail::Adder_addition_Result{};
                        reply.addition->result = calculator_base::detail::Adder_addition_Out{};
                    ...
                    catch (const calculator_base::OverflowException& ex)
                    {
                        ReplyType reply{};
                        reply.addition = calculator_base::detail::Adder_addition_Result{};
                        reply.addition->calculator_base_OverflowException_ex = ex;
                        replier_->send_reply(&reply, req->info);
                    }
                    break;
                }
                ...
                if (req->request.subtraction.has_value())
                {
                    try
                    {
                        ...
                        ReplyType reply{};
                        reply.subtraction = calculator_base::detail::Subtractor_subtraction_Result{};
                        reply.subtraction->result = calculator_base::detail::Subtractor_subtraction_Out{};
                    ...
                    catch (const calculator_base::OverflowException& ex)
                    {
                        ReplyType reply{};
                        reply.subtraction = calculator_base::detail::Subtractor_subtraction_Result{};
                        reply.subtraction->calculator_base_OverflowException_ex = ex;
                        replier_->send_reply(&reply, req->info);
                    }
                    break;
                }
                ...
                {
                    {
                        ...
                        reply.representation_limits->result = calculator_base::detail::BasicCalculator_representation_limits_Out{};
