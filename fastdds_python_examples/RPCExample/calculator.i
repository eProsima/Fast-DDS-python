...
%module(directors="1",moduleimport="if __import__('os').name == 'nt': import win32api; win32api.LoadLibrary('calculator.dll')\nif __package__ or '.' in __name__:\n    from . import _calculatorWrapper\nelse:\n    import _calculatorWrapper") calculator
...
%shared_ptr(eprosima::fastdds::dds::rpc::RpcFuture<void>);
%template(void_rpc_future) eprosima::fastdds::dds::rpc::RpcFuture<void>;

%typemap(out, optimal="1") eprosima::fastdds::dds::rpc::RpcFuture<void> {
  std::shared_ptr<$1_ltype> *smartresult = new std::shared_ptr<$1_ltype>(new $1_ltype($1));
  $result = SWIG_NewPointerObj(SWIG_as_voidptr(smartresult), $descriptor(std::shared_ptr< eprosima::fastdds::dds::rpc::RpcFuture<void>> *), SWIG_POINTER_OWN);
}
