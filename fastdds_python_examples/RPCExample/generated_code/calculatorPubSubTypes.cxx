...
public:
    ...
    typedef detail::BasicCalculator_Request type;

    // Constructor
    BasicCalculator_RequestPubSubType()
    {
        set_name("calculator_base::BasicCalculator_Request");
    ...
    // Destructor
    ~BasicCalculator_RequestPubSubType() override = default;
...
public:
    // Alias for the type to be serialized.
    typedef detail::BasicCalculator_Reply type;

    // Constructor
    BasicCalculator_ReplyPubSubType()
    {
        set_name("calculator_base::BasicCalculator_Reply");
        uint32_t type_size = 56UL;
        type_size += static_cast<uint32_t>(eprosima::fastcdr::Cdr::alignment(type_size, 4)); /* possible submessage alignment */
        max_serialized_type_size = type_size + 4; /*encapsulation*/
        is_compute_key_provided = false;
    ...
    // Destructor
    ~BasicCalculator_ReplyPubSubType() override = default;
...
eprosima::fastdds::dds::rpc::ServiceTypeSupport create_BasicCalculator_service_type_support()
{
    eprosima::fastdds::dds::TypeSupport request_type(
        new BasicCalculator_RequestPubSubType());
    eprosima::fastdds::dds::TypeSupport reply_type(
        new BasicCalculator_ReplyPubSubType());
