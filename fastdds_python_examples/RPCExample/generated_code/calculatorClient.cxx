...
class BasicCalculatorClient : public BasicCalculator
{
...
public:
        ...
        , participant_(part)
    {
        ...
        auto service_type = create_BasicCalculator_service_type_support();
        auto ret = service_type.register_service_type(&participant_, "calculator_base::BasicCalculator");
        ...
        // Create the service
        service_ = participant_.create_service(service_name, "calculator_base::BasicCalculator");
        if (nullptr == service_)
        {
    ...
    ~BasicCalculatorClient() override
    {
...
private:
    ...
    {
        stop_thread_ = false;
        processing_thread_ = std::thread(&BasicCalculatorClient::run, this);
    }
...
public:
            ...
            /*in*/ int32_t value2) override
    {
        ...
        RequestType request;
        request.addition = calculator_base::detail::Adder_addition_In{};
    ...
    struct addition_promise : public IReplyProcessor
    {
                ...
                bool& should_remove) override
        {
            ...
            if (reply.addition.has_value())
            {
                ...
                if (result.calculator_base_OverflowException_ex.has_value())
                {
                    promise.set_exception(
                        std::make_exception_ptr(result.calculator_base_OverflowException_ex.value()));
                    return;
                }
            }
...
public:
            ...
            /*in*/ int32_t value2) override
    {
        ...
        // Create and send the request
        RequestType request;
        request.subtraction = calculator_base::detail::Subtractor_subtraction_In{};
...
public:
    ...
    eprosima::fastdds::dds::rpc::RpcFuture<calculator_base::detail::BasicCalculator_representation_limits_Out> representation_limits(
) override
    {
        // Create a promise to hold the result
        ...
        // Create and send the request
        RequestType request;
        request.representation_limits = calculator_base::detail::BasicCalculator_representation_limits_In{};
        return send_request_with_promise(request, result, result->promise);
    }
...
private:
    ...
    {
        std::promise<calculator_base::detail::BasicCalculator_representation_limits_Out> promise;
...
std::shared_ptr<BasicCalculator> create_BasicCalculatorClient(
        eprosima::fastdds::dds::DomainParticipant& part,
        const char* service_name,
        const eprosima::fastdds::dds::RequesterQos& qos)
{
    return std::make_shared<detail::BasicCalculatorClient>(part, service_name, qos);
}

//} interface BasicCalculatorClient
...
public:
        ...
        , participant_(part)
    {
        ...
        auto ret = service_type.register_service_type(&participant_, "Calculator");
        if (ret != fdds::RETCODE_OK)
        {
            throw std::runtime_error("Error registering service type");
        }
        ...
        // Create the service
        service_ = participant_.create_service(service_name, "Calculator");
        if (nullptr == service_)
        {
            throw std::runtime_error("Error creating service");
        }
...
public:
            ...
            /*in*/ uint32_t n_results) override
    {
        ...
        // Create and send the request
        RequestType request;
        request.fibonacci_seq = detail::Calculator_fibonacci_seq_In{};
...
public:
            ...
            /*in*/ std::shared_ptr<eprosima::fastdds::dds::rpc::RpcClientWriter<int32_t>>& value) override
    {
        ...
        // Create and send the request
        RequestType request;
        request.sum_all = detail::Calculator_sum_all_In{};
...
private:
    ...
    {
        using FeedType = detail::Calculator_sum_all_value_Feed;
...
public:
            ...
            /*in*/ std::shared_ptr<eprosima::fastdds::dds::rpc::RpcClientWriter<int32_t>>& value) override
    {
        ...
        // Create and send the request
        RequestType request;
        request.accumulator = detail::Calculator_accumulator_In{};
...
private:
    ...
    {
        using FeedType = detail::Calculator_accumulator_value_Feed;
