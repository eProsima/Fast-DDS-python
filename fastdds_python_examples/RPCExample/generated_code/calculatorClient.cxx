...
public:
    ...
    eprosima::fastdds::dds::rpc::RpcFuture<detail::Calculator_representation_limits_Out> representation_limits(
) override
    {
        // Create a promise to hold the result
        auto result = std::make_shared<representation_limits_promise>();
        ...
        // Create and send the request
        RequestType request;
        request.representation_limits = detail::Calculator_representation_limits_In{};
        return send_request_with_promise(request, result, result->promise);
    }
...
private:
    ...
    struct representation_limits_promise : public IReplyProcessor
    {
        std::promise<detail::Calculator_representation_limits_Out> promise;
