...
breathe_projects = {
    'fastdds_python': os.path.abspath('{}/xml'.format(output_dir))
}
breathe_default_project = 'fastdds_python'
...
project = u'Fast DDS Python bindings'
...
htmlhelp_basename = 'FastDDS Python Bindings Manual'
...
latex_documents = [
    (master_doc,
     'fastdds_python.tex',
     u'Fast DDS Python Bindings Documentation',
     u'eProsima',
     'manual'),
]
...
texinfo_documents = [
    (master_doc,
     ...
     author,
     'Fast DDS Python Bindings',
     'Documentation of eProsima Fast DDS Python Bindings',
     'Miscellaneous'),
]
