...
%feature("valuewrapper") eprosima::fastdds::rtps::LocatorSelector::iterator;

// Once flattened, these give very unusual errors
%ignore eprosima::fastdds::rtps::LocatorSelector::iterator::operator->;

// Need to create a custom name for the flattened iterator
// since other classes also define the same inner class
%rename (LocatorSelector_iterator) eprosima::fastdds::rtps::LocatorSelector::iterator;
