...
def fill_keyed_complete_test_type(data):
    ...
    data.fixed_string_field("Fixed string")
    ...
    data.fixed_string_opt_field().set_value("Fixed string")
...
def check_keyed_complete_test_type(data):
    ...
    assert(data.fixed_string_opt_field().has_value())
    assert(data.fixed_string_opt_field().get_value() == "Fixed string")
