        ...
        const eprosima::test::CompleteTestType& data)
{
    ...
    scdr
        ...
        << eprosima::fastcdr::MemberId(15) << data.array_char_field()
        << eprosima::fastcdr::MemberId(16) << data.array_uint8_field()
        << eprosima::fastcdr::MemberId(17) << data.array_int16_field()
        << eprosima::fastcdr::MemberId(18) << data.array_uint16_field()
        << eprosima::fastcdr::MemberId(19) << data.array_int32_field()
        << eprosima::fastcdr::MemberId(20) << data.array_uint32_field()
        << eprosima::fastcdr::MemberId(21) << data.array_int64_field()
        << eprosima::fastcdr::MemberId(22) << data.array_uint64_field()
        << eprosima::fastcdr::MemberId(23) << data.array_float_field()
        << eprosima::fastcdr::MemberId(24) << data.array_double_field()
        << eprosima::fastcdr::MemberId(25) << data.array_bool_field()
        << eprosima::fastcdr::MemberId(26) << data.array_enum_field()
        << eprosima::fastcdr::MemberId(27) << data.array_enum2_field()
        << eprosima::fastcdr::MemberId(28) << data.array_struct_field()
        << eprosima::fastcdr::MemberId(29) << data.bounded_sequence_char_field()
        << eprosima::fastcdr::MemberId(30) << data.bounded_sequence_uint8_field()
        << eprosima::fastcdr::MemberId(31) << data.bounded_sequence_int16_field()
        << eprosima::fastcdr::MemberId(32) << data.bounded_sequence_uint16_field()
        << eprosima::fastcdr::MemberId(33) << data.bounded_sequence_int32_field()
        << eprosima::fastcdr::MemberId(34) << data.bounded_sequence_uint32_field()
        << eprosima::fastcdr::MemberId(35) << data.bounded_sequence_int64_field()
        << eprosima::fastcdr::MemberId(36) << data.bounded_sequence_uint64_field()
        << eprosima::fastcdr::MemberId(37) << data.bounded_sequence_float_field()
        << eprosima::fastcdr::MemberId(38) << data.bounded_sequence_double_field()
        << eprosima::fastcdr::MemberId(39) << data.bounded_sequence_bool_field()
        << eprosima::fastcdr::MemberId(40) << data.bounded_sequence_enum_field()
        << eprosima::fastcdr::MemberId(41) << data.bounded_sequence_enum2_field()
        << eprosima::fastcdr::MemberId(42) << data.bounded_sequence_struct_field()
        << eprosima::fastcdr::MemberId(43) << data.unbounded_sequence_char_field()
        << eprosima::fastcdr::MemberId(44) << data.unbounded_sequence_uint8_field()
        << eprosima::fastcdr::MemberId(45) << data.unbounded_sequence_int16_field()
        << eprosima::fastcdr::MemberId(46) << data.unbounded_sequence_uint16_field()
        << eprosima::fastcdr::MemberId(47) << data.unbounded_sequence_int32_field()
        << eprosima::fastcdr::MemberId(48) << data.unbounded_sequence_uint32_field()
        << eprosima::fastcdr::MemberId(49) << data.unbounded_sequence_int64_field()
        << eprosima::fastcdr::MemberId(50) << data.unbounded_sequence_uint64_field()
        << eprosima::fastcdr::MemberId(51) << data.unbounded_sequence_float_field()
        << eprosima::fastcdr::MemberId(52) << data.unbounded_sequence_double_field()
        << eprosima::fastcdr::MemberId(53) << data.unbounded_sequence_bool_field()
        << eprosima::fastcdr::MemberId(54) << data.unbounded_sequence_enum_field()
        << eprosima::fastcdr::MemberId(55) << data.unbounded_sequence_enum2_field()
        << eprosima::fastcdr::MemberId(56) << data.unbounded_sequence_struct_field()
;
        ...
        const eprosima::test::KeyedCompleteTestType& data)
{
    ...
    scdr
        ...
        << eprosima::fastcdr::MemberId(26) << data.array_bool_field()
        << eprosima::fastcdr::MemberId(27) << data.array_enum_field()
        << eprosima::fastcdr::MemberId(28) << data.array_enum2_field()
        << eprosima::fastcdr::MemberId(29) << data.array_struct_field()
        << eprosima::fastcdr::MemberId(30) << data.bounded_sequence_char_field()
        << eprosima::fastcdr::MemberId(31) << data.bounded_sequence_uint8_field()
        << eprosima::fastcdr::MemberId(32) << data.bounded_sequence_int16_field()
        << eprosima::fastcdr::MemberId(33) << data.bounded_sequence_uint16_field()
        << eprosima::fastcdr::MemberId(34) << data.bounded_sequence_int32_field()
        << eprosima::fastcdr::MemberId(35) << data.bounded_sequence_uint32_field()
        << eprosima::fastcdr::MemberId(36) << data.bounded_sequence_int64_field()
        << eprosima::fastcdr::MemberId(37) << data.bounded_sequence_uint64_field()
        << eprosima::fastcdr::MemberId(38) << data.bounded_sequence_float_field()
        << eprosima::fastcdr::MemberId(39) << data.bounded_sequence_double_field()
        << eprosima::fastcdr::MemberId(40) << data.bounded_sequence_bool_field()
        << eprosima::fastcdr::MemberId(41) << data.bounded_sequence_enum_field()
        << eprosima::fastcdr::MemberId(42) << data.bounded_sequence_enum2_field()
        << eprosima::fastcdr::MemberId(43) << data.bounded_sequence_struct_field()
        << eprosima::fastcdr::MemberId(44) << data.unbounded_sequence_char_field()
        << eprosima::fastcdr::MemberId(45) << data.unbounded_sequence_uint8_field()
        << eprosima::fastcdr::MemberId(46) << data.unbounded_sequence_int16_field()
        << eprosima::fastcdr::MemberId(47) << data.unbounded_sequence_uint16_field()
        << eprosima::fastcdr::MemberId(48) << data.unbounded_sequence_int32_field()
        << eprosima::fastcdr::MemberId(49) << data.unbounded_sequence_uint32_field()
        << eprosima::fastcdr::MemberId(50) << data.unbounded_sequence_int64_field()
        << eprosima::fastcdr::MemberId(51) << data.unbounded_sequence_uint64_field()
        << eprosima::fastcdr::MemberId(52) << data.unbounded_sequence_float_field()
        << eprosima::fastcdr::MemberId(53) << data.unbounded_sequence_double_field()
        << eprosima::fastcdr::MemberId(54) << data.unbounded_sequence_bool_field()
        << eprosima::fastcdr::MemberId(55) << data.unbounded_sequence_enum_field()
        << eprosima::fastcdr::MemberId(56) << data.unbounded_sequence_enum2_field()
        << eprosima::fastcdr::MemberId(57) << data.unbounded_sequence_struct_field()
;
