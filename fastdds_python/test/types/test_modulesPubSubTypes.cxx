...
{
    const ::eprosima::test::StructType* p_type =
            static_cast<const ::eprosima::test::StructType*>(data);
        ...
        void* data)
{
    try
    {
        ...
        ::eprosima::test::StructType* p_type =
                static_cast<::eprosima::test::StructType*>(data);
...
bool CompleteTestTypePubSubType::serialize(
        ...
        DataRepresentationId_t data_representation)
{
    const ::eprosima::test::CompleteTestType* p_type =
            static_cast<const ::eprosima::test::CompleteTestType*>(data);
        ...
        void* data)
{
    ...
    {
        // Convert DATA to pointer of your type
        ::eprosima::test::CompleteTestType* p_type =
                static_cast<::eprosima::test::CompleteTestType*>(data);
...
bool KeyedCompleteTestTypePubSubType::serialize(
        ...
        DataRepresentationId_t data_representation)
{
    const ::eprosima::test::KeyedCompleteTestType* p_type =
            static_cast<const ::eprosima::test::KeyedCompleteTestType*>(data);
        ...
        void* data)
{
    ...
    {
        // Convert DATA to pointer of your type
        ::eprosima::test::KeyedCompleteTestType* p_type =
                static_cast<::eprosima::test::KeyedCompleteTestType*>(data);
...
unsigned char* KeyedCompleteTestTypePubSubType::get_key_buffer_nts()
{
    ...
    uint32_t key_length = (std::max)(eprosima_test_KeyedCompleteTestType_max_key_cdr_typesize, 16u);
