...
#include "test_modulesPubSubTypes.hpp"
...
namespace eprosima {
    namespace test {
        ...
        {
            set_name("eprosima::test::StructType");
            uint32_t type_size = eprosima_test_StructType_max_cdr_typesize;
            type_size += static_cast<uint32_t>(eprosima::fastcdr::Cdr::alignment(type_size, 4)); /* possible submessage alignment */
            max_serialized_type_size = type_size + 4; /*encapsulation*/
            is_compute_key_provided = false;
            uint32_t key_length = eprosima_test_StructType_max_key_cdr_typesize > 16 ? eprosima_test_StructType_max_key_cdr_typesize : 16;
        ...
        {
            const ::eprosima::test::StructType* p_type = static_cast<const ::eprosima::test::StructType*>(data);
                ...
                void* data)
        {
            try
            {
                ...
                ::eprosima::test::StructType* p_type = static_cast<::eprosima::test::StructType*>(data);
                ...
                DataRepresentationId_t data_representation)
        {
            try
            {
                ...
                return static_cast<uint32_t>(calculator.calculate_serialized_size(
                            *static_cast<const ::eprosima::test::StructType*>(data), current_alignment)) +
                        4u /*encapsulation*/;
            }
            catch (eprosima::fastcdr::exception::Exception& /*exception*/)
            {
        ...
        {
            return reinterpret_cast<void*>(new ::eprosima::test::StructType());
        }

        void StructTypePubSubType::delete_data(
                void* data)
        {
            delete(reinterpret_cast<::eprosima::test::StructType*>(data));
        }
        ...
        CompleteTestTypePubSubType::CompleteTestTypePubSubType()
        {
            ...
            max_serialized_type_size = type_size + 4; /*encapsulation*/
            is_compute_key_provided = false;
            uint32_t key_length = eprosima_test_CompleteTestType_max_key_cdr_typesize > 16 ? eprosima_test_CompleteTestType_max_key_cdr_typesize : 16;
            key_buffer_ = reinterpret_cast<unsigned char*>(malloc(key_length));
            memset(key_buffer_, 0, key_length);
        }
        ...
        bool CompleteTestTypePubSubType::serialize(
                ...
                DataRepresentationId_t data_representation)
        {
            const ::eprosima::test::CompleteTestType* p_type = static_cast<const ::eprosima::test::CompleteTestType*>(data);
                ...
                void* data)
        {
            ...
            {
                // Convert DATA to pointer of your type
                ::eprosima::test::CompleteTestType* p_type = static_cast<::eprosima::test::CompleteTestType*>(data);
                ...
                DataRepresentationId_t data_representation)
        {
            try
            {
                ...
                size_t current_alignment {0};
                return static_cast<uint32_t>(calculator.calculate_serialized_size(
                            *static_cast<const ::eprosima::test::CompleteTestType*>(data), current_alignment)) +
                        4u /*encapsulation*/;
            }
            catch (eprosima::fastcdr::exception::Exception& /*exception*/)
            {
        ...
        {
            return reinterpret_cast<void*>(new ::eprosima::test::CompleteTestType());
        }

        void CompleteTestTypePubSubType::delete_data(
                void* data)
        {
            delete(reinterpret_cast<::eprosima::test::CompleteTestType*>(data));
        }
        ...
        {
            set_name("eprosima::test::KeyedCompleteTestType");
            uint32_t type_size = eprosima_test_KeyedCompleteTestType_max_cdr_typesize;
            type_size += static_cast<uint32_t>(eprosima::fastcdr::Cdr::alignment(type_size, 4)); /* possible submessage alignment */
            max_serialized_type_size = type_size + 4; /*encapsulation*/
            is_compute_key_provided = true;
            uint32_t key_length = eprosima_test_KeyedCompleteTestType_max_key_cdr_typesize > 16 ? eprosima_test_KeyedCompleteTestType_max_key_cdr_typesize : 16;
            key_buffer_ = reinterpret_cast<unsigned char*>(malloc(key_length));
            memset(key_buffer_, 0, key_length);
        }
        ...
        bool KeyedCompleteTestTypePubSubType::serialize(
                ...
                DataRepresentationId_t data_representation)
        {
            const ::eprosima::test::KeyedCompleteTestType* p_type = static_cast<const ::eprosima::test::KeyedCompleteTestType*>(data);
                ...
                void* data)
        {
            ...
            {
                // Convert DATA to pointer of your type
                ::eprosima::test::KeyedCompleteTestType* p_type = static_cast<::eprosima::test::KeyedCompleteTestType*>(data);
                ...
                DataRepresentationId_t data_representation)
        {
            try
            {
                ...
                size_t current_alignment {0};
                return static_cast<uint32_t>(calculator.calculate_serialized_size(
                            *static_cast<const ::eprosima::test::KeyedCompleteTestType*>(data), current_alignment)) +
                        4u /*encapsulation*/;
            }
            catch (eprosima::fastcdr::exception::Exception& /*exception*/)
            {
        ...
        {
            return reinterpret_cast<void*>(new ::eprosima::test::KeyedCompleteTestType());
        }

        void KeyedCompleteTestTypePubSubType::delete_data(
                void* data)
        {
            delete(reinterpret_cast<::eprosima::test::KeyedCompleteTestType*>(data));
        }
