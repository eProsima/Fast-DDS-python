...
private:
    ...
    eprosima::test::Color m_enum_field{eprosima::test::RED};
    eprosima::test::Material m_enum2_field{eprosima::test::WOOD};
...
public:
     ...
     */
    eProsima_user_DllExport const eprosima::fastcdr::optional<eprosima::test::Color>& enum_opt_field() const;

    /*!
     * @brief This function returns a reference to member enum_opt_field
     * @return Reference to member enum_opt_field
     */
    eProsima_user_DllExport eprosima::fastcdr::optional<eprosima::test::Color>& enum_opt_field();
     ...
     */
    eProsima_user_DllExport const eprosima::fastcdr::optional<eprosima::test::Material>& enum2_opt_field() const;

    /*!
     * @brief This function returns a reference to member enum2_opt_field
     * @return Reference to member enum2_opt_field
     */
    eProsima_user_DllExport eprosima::fastcdr::optional<eprosima::test::Material>& enum2_opt_field();
     ...
     */
    eProsima_user_DllExport const eprosima::fastcdr::optional<eprosima::test::StructType>& struct_opt_field() const;

    /*!
     * @brief This function returns a reference to member struct_opt_field
     * @return Reference to member struct_opt_field
     */
    eProsima_user_DllExport eprosima::fastcdr::optional<eprosima::test::StructType>& struct_opt_field();
     ...
     */
    eProsima_user_DllExport const std::array<eprosima::test::Color, max_array_size>& array_enum_field() const;

    /*!
     * @brief This function returns a reference to member array_enum_field
     * @return Reference to member array_enum_field
     */
    eProsima_user_DllExport std::array<eprosima::test::Color, max_array_size>& array_enum_field();
     ...
     */
    eProsima_user_DllExport const std::array<eprosima::test::Material, max_array_size>& array_enum2_field() const;

    /*!
     * @brief This function returns a reference to member array_enum2_field
     * @return Reference to member array_enum2_field
     */
    eProsima_user_DllExport std::array<eprosima::test::Material, max_array_size>& array_enum2_field();
     ...
     */
    eProsima_user_DllExport const std::array<eprosima::test::StructType, max_array_size>& array_struct_field() const;

    /*!
     * @brief This function returns a reference to member array_struct_field
     * @return Reference to member array_struct_field
     */
    eProsima_user_DllExport std::array<eprosima::test::StructType, max_array_size>& array_struct_field();
...
private:
    ...
    eprosima::fastcdr::optional<eprosima::test::Color> m_enum_opt_field;
    eprosima::fastcdr::optional<eprosima::test::Material> m_enum2_opt_field;
    eprosima::fastcdr::optional<eprosima::test::StructType> m_struct_opt_field;
    ...
    std::array<eprosima::test::Color, max_array_size> m_array_enum_field{eprosima::test::RED};
    std::array<eprosima::test::Material, max_array_size> m_array_enum2_field{eprosima::test::WOOD};
    std::array<eprosima::test::StructType, max_array_size> m_array_struct_field;
