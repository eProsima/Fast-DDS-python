...
namespace eprosima {
    namespace test {
        ...
        public:
             ...
             */
            eProsima_user_DllExport const std::array<eprosima::test::Color, 3>& array_enum_field() const;

            /*!
             * @brief This function returns a reference to member array_enum_field
             * @return Reference to member array_enum_field
             */
            eProsima_user_DllExport std::array<eprosima::test::Color, 3>& array_enum_field();
             ...
             */
            eProsima_user_DllExport const std::array<eprosima::test::Material, 3>& array_enum2_field() const;

            /*!
             * @brief This function returns a reference to member array_enum2_field
             * @return Reference to member array_enum2_field
             */
            eProsima_user_DllExport std::array<eprosima::test::Material, 3>& array_enum2_field();
             ...
             */
            eProsima_user_DllExport const std::array<eprosima::test::StructType, 3>& array_struct_field() const;

            /*!
             * @brief This function returns a reference to member array_struct_field
             * @return Reference to member array_struct_field
             */
            eProsima_user_DllExport std::array<eprosima::test::StructType, 3>& array_struct_field();
        ...
        private:
            ...
            std::array<eprosima::test::Color, 3> m_array_enum_field{eprosima::test::RED};
            std::array<eprosima::test::Material, 3> m_array_enum2_field{eprosima::test::WOOD};
            std::array<eprosima::test::StructType, 3> m_array_struct_field;
