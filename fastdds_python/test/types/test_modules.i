...
}%template(eprosima_test_Color_vector) std::vector<eprosima::test::Color>;
...
}%template(eprosima_test_Material_vector) std::vector<eprosima::test::Material>;
...
%template(eprosima_test_StructType_vector) std::vector<eprosima::test::StructType>;
