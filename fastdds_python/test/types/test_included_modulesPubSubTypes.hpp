...
/*!
 * @file test_included_modulesPubSubTypes.hpp
...
#ifndef FAST_DDS_GENERATED__TEST_INCLUDED_MODULES_IDL_EPROSIMA_TEST2_PUBSUBTYPES_HPP
#define FAST_DDS_GENERATED__TEST_INCLUDED_MODULES_IDL_EPROSIMA_TEST2_PUBSUBTYPES_HPP
...
#error \
    Generated test_included_modules is not compatible with current installed Fast DDS. Please, regenerate it with fastddsgen.
 ...
 */
class StructType2PubSubType : public eprosima::fastdds::dds::TopicDataType
{
public:

    typedef StructType2 type;

    eProsima_user_DllExport StructType2PubSubType();
...
#endif // FAST_DDS_GENERATED__TEST_INCLUDED_MODULES_IDL_EPROSIMA_TEST2_PUBSUBTYPES_HPP
